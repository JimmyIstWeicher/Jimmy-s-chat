  ...
  return (
    ...
    >
      <div className="flex items-center justify-start gap-3">
        ...
        {isPlaying ? (
          <button className="btn  btn-outline  btn-circle" onClick={handlePause}>
            <FaPause />{" "}
          </button>
        ) : (
          <button className="btn  btn-outline  btn-circle" onClick={handlePlay}>
            <FaPlay />
          </button>
        )}
        <button className="btn  btn-outline  btn-circle" onClick={handleStop}>
          <FaStop />
        </button>
      </div>
    </IconContext.Provider>
